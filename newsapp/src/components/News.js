      ...
      <div className='container my-3'>
        ...
        <div className="row">
          ...
          <div className="col-md-3"> 
            <NewsItem title="MyTitle" description="myDescription" imageUrl="https://ichef.bbci.co.uk/news/1024/cpsprodpb/13037/production/_130197877_andersonfirstpitch2.jpg" newsUrl="ToDo"/> {/*way to pass value of title and description*/}
          </div>
          <div className="col-md-3"> 
